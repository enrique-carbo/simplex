...
import JeanLidase from '@/assets/images/products/jean-lidase.jpg';
...
import MochilaAlpineSkate from '@/assets/images/products/mochila-calle.jpg';
...
const carouselItems = [
  ...
  {
    image: MochilaAlpineSkate,
    alt: 'Mochila Alpine Skate',
  },
  { image: RemeraAzul, alt: 'Remera Azul' },
  {
    image: SudaderaVerde,
    alt: 'Sudadera Verde',
  },
